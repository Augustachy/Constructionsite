    ...
    >
      ...
      >
        ...
        <Link href="/" className="flex items-center gap-1 group shrink-0">
          <Image
            src={isScrolled ? "/images/Logos.png" : "/images/Logo.png"}
            alt="Ogochukwuebuka Logo"
            width={200}
            height={200}
            priority
            className="object-contain group-hover:scale-105 transition-transform w-auto h-12"
          />
        </Link>
              ...
              className={`font-body text-sm font-medium tracking-wide transition-colors relative group ${
                pathname === link.href
                  ...
                  : desktopScrolled
                    ...
                    : "text-colorbo hover:text-colorbrand"
              }`}
            >
              {link.label}
              <span
                className={`absolute -bottom-1 left-0 h-px transition-all duration-300 ${
                  desktopScrolled ? "bg-white" : "bg-[#00AEEF]"
                } ${
                  pathname === link.href
                    ? "w-full" // ✅ always show underline when active
          ...
          <Link
            ...
            className={`ml-2 px-5 py-2.5 text-sm font-semibold rounded-lg transition-all shadow-lg hover:scale-105 ${
              desktopScrolled
                ...
                : "bg-colorbrand text-white hover:bg-[#00AEEF] hover:border-[#00AEEF]"
            }`}
          >
            Get a Quote
          </Link>
        ...
        {/* Mobile toggle */}
        <button
          className="md:hidden  bg-colorbrand text-white p-2 rounded-lg hover:bg-colorbrandtransition-colors"
