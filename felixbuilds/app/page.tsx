...
export const metadata: Metadata = {
  title:
    "Ogochukwuebuka Construction Company & Properties Ltd | Premium Construction Company in Nigeria",
  description:
    "Nigeria's most trusted construction company. 15+ years delivering world-class residential, commercial & industrial projects. Get your free quote today.",
...
export default function HomePage() {
  return (
    <>
      {/* HERO */}
      <section className="relative flex items-center justify-center overflow-hidden py-16 lg:py-30">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10 pt-32 pb-20 text-center">
          ...
          <p className="max-w-2xl mx-auto text-gray-100 text-lg lg:text-xl leading-relaxed mb-10">
            From residential buildings to commercial projects — we deliver
            professional construction services across Nigeria with quality
            materials, precision, and reliable project execution grounded in
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-colorbo text-base leading-relaxed mb-6">
                Ogochukwuebuka Construction Company & Properties Ltd provides
                comprehensive building and construction services across Nigeria,
                covering residential, commercial, and a variety of other project
                types, while also specializing in the sale of high-quality
                properties designed for long-term value.
              </p>

              <p className="text-colorbo text-base leading-relaxed mb-8">
                With a strong foundation of experience, we maintain a commitment
                to transparency, excellence, and efficient project execution,
                delivering lasting value through integrated construction
                expertise and property sales.
              </p>
            ...
            <div className="relative">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
                <Image
                  ...
                  alt="A man drawing building plan"
                  fill
           ...
           sizes=(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
              ...
              {/* FLOATING CARD */}
              <div className="absolute -bottom-6 -right-2 bg-colorbo text-colorbrand p-2 rounded-xl shadow-2xl">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-14">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-5xl font-bold text-colorbo">
                End-to-End <br />
                <span className="text-gradient">Construction Services</span>
              </h2>
            </div>
            <Link
              href="/services"
              className="text-[#00AEEF] flex items-center gap-2 text-sm font-semibold hover:gap-3 transition-all group"
            >
              All Services{" "}
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-14">
            <div>
              ...
              <h2 className="font-display text-4xl lg:text-5xl font-bold text-colorb">
                {" "}
            ...
            <Link
              href="/projects"
              className="inline-flex items-center gap-2 px-6 py-3 border border-[#00AEEF] text-[#00AEEF] font-semibold text-sm rounded-xl hover:bg-colorbrand hover:text-white transition-all group"
            >
              View All Projects
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
          ...
          <div className="mt-10 text-center">
            <Link
              href="/projects"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-colorbrand text-white font-bold rounded-xl hover:bg-colorbrand transition-all text-base shadow-xl shadow-sky-900/30 hover:scale-105"
            >
              View More Projects
              <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
            </Link>
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-colorbo text-sm leading-relaxed mb-4">
                We deliver reliable construction solutions with high-quality
                materials, skilled craftsmanship, and timely project execution
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-display text-4xl lg:text-5xl font-bold text-black mb-2">
            Ready to Build Something Great?
          </h2>
          <p className="text-black/70 text-lg mb-8">
            Contact our team today and let's discuss how we can bring your
            vision to life.
          </p>
          <Link
            href="/contact#quote"
